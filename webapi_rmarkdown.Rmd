---
title: "webapi"
author: "Coskun Erden, Alex Cleveringa, Eshita Zaman"
date: "4/9/2022"
output:
...
token <- #your API_KEY
req_data <- httr::GET(
  paste0(url, "top-headlines?country =us&category=sports&apiKey=token")
)
...
news_to_df <- tr_news$articles %>% purrr::map_df(news_to_df)
