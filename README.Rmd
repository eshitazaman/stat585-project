...
---
 ...
 <!-- badges: start -->
  [![Codecov test coverage](https://codecov.io/gh/eshitazaman/stat585-project/branch/main/graph/badge.svg)](https://app.codecov.io/gh/eshitazaman/stat585-project?branch=main)
  <!-- badges: end -->
