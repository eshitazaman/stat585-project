...
Authenticating the connection with the Newsapi API is done at the same time the woRldnews is initialized.

## Searchinng for headlines

From the select boxes on the shiny.app, users select the country and category for the news search. 

![Search box](/Users/cerden/Desktop/stat585-project/headlines.png)

In a table format, there are 20 top headlines with title, description, date, url, and url to image. By clicking on the urls and urltoimage links, users can access related websites. 

![Search results](/Users/cerden/Desktop/stat585-project/results.png)
